...
class TernSecureRequest extends Request {
    ...
    public constructor(input: TernSecureRequest | Request | RequestInfo, init?: RequestInit) {
...
export const createTernSecureRequest = (...args: ConstructorParameters<typeof TernSecureRequest>): TernSecureRequest => {
